...
import mlflow
import dagshub
dagshub.init(repo_owner='vishalkr8744', repo_name='NETWORKSECURITY', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self, best_model, classificationmetric):
     mlflow.set_tracking_uri("https://dagshub.com/vishalkr8744/NETWORKSECURITY.mlflow")
